define([
    ...
    $.widget('TemplateMonster.themeChild', $.TemplateMonster.theme, {
        ...
        options: {
            ...
            blogWidgetCarousel: {
                selector: ".column .widget.blog-posts .post-items",
                params: {
                    items: 3,
                    itemsDesktop: [1199, 3],
                    itemsDesktopSmall: [979, 2],
        ...
        _blogWidgetCarousel: function () {
            var blogWidgetCarouselData = this.options.blogWidgetCarousel;
            $(blogWidgetCarouselData.selector).carouselInit(blogWidgetCarouselData.params);
        },
        title_wrap: function () {
