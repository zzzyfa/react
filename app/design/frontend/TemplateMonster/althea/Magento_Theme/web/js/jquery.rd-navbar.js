...
(function () {
  ...
  (function ($, document, window) {
    ...
    RDNavbar = (function () {
      ...
      RDNavbar.prototype.initializeDropdown = function () {
        var ctx;
        ctx = this;
        if (ctx.$element) {
          if (ctx.$element.find(".rd-navbar-nav .has-active > .rd-navbar-submenu-toggle").length) {
            ctx.$element.find(".rd-navbar-nav .has-active > .rd-navbar-submenu-toggle")[0].click();
          }
          if (ctx.$element.find(".rd-navbar-nav .active > .rd-navbar-submenu-toggle").length) {
            ctx.$element.find(".rd-navbar-nav .active > .rd-navbar-submenu-toggle")[0].click();
          }
        }
      };
      ...
      RDNavbar.prototype.createNav = function (ctx) {
        //ctx.$element.find('.rd-navbar-nav').addClass('show');
      ...
      RDNavbar.prototype.switchToggle = function (ctx, e) {
        ...
        if (linkedElements = this.getAttribute('data-rd-navbar-toggle')) {
          $('[data-rd-navbar-toggle]').not(this).each(function () {
            var deactivateElements = this.getAttribute('data-rd-navbar-toggle');
            if (deactivateElements) {
              if(linkedElements == deactivateElements){
      ...
      RDNavbar.prototype.dropdownClose = function (ctx, e) {
        ...
        if (e.target !== this && !$(e.target).parents('.rd-navbar-submenu').length) {
          $this.find('li.focus').add(this).removeClass('focus').removeClass('opened').removeClass('hide');
        ...
        else if (e.target !== this && !$(e.target).parents('.level-top').length) {
          $this.parent().siblings().removeClass('hide');
        }
      ...
      RDNavbar.prototype.dropdownToggle = function (ctx) {
        ...
        if ($el.hasClass('opened')) {
          ...
          $el.addClass('opened');
          $el.siblings().removeClass('opened').addClass('hide');
          $el.parent().siblings().addClass('hide');
        }
      ...
      RDNavbar.prototype.applyHandlers = function (ctx) {
        ...
        //ctx.$element.add(ctx.$clone).find('.rd-navbar-nav-bg').each(function () {
        //  var $this;
        //  $this = $(this);
        //  $this.on((isTouch ? 'touchstart' : 'click'), $.proxy(ctx.switchToggle, this, ctx));
        //});
