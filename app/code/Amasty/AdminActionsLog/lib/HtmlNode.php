...
class HtmlNode {
	 ...
	 * @see setInnerText()
	 */
	var $parserClass = 'HtmlParserHTML5';
	 ...
	 * @var string
	 */
	var $childClass_Text = 'HtmlNodeText';
	/**
	 * Name of the class used for {@link addComment()}
	 * @var string
	 */
	var $childClass_Comment = 'HtmlNodeComment';
	/**
	 * Name of the class used for {@link addContional()}
	 * @var string
	 */
	var $childClass_Conditional = 'HtmlNodeConditional';
	/**
	 * Name of the class used for {@link addCDATA()}
	 * @var string
	 */
	var $childClass_CDATA = 'HtmlNodeCdata';
	/**
	 * Name of the class used for {@link addDoctype()}
	 * @var string
	 */
	var $childClass_Doctype = 'HtmlNodeDoctype';
	/**
	 * Name of the class used for {@link addXML()}
	 * @var string
	 */
	var $childClass_XML = 'HtmlNodeXML';
	/**
	 * Name of the class used for {@link addASP()}
	 * @var string
	 */
	var $childClass_ASP = 'HtmlNodeAsp';
