...
class Banner extends AbstractModel implements BannerInterface, IdentityInterface {
	 ...
	 * Banner cache tag
	 */
	const CACHE_TAG = 'althea_cms_banner';
	 ...
	 * @var string
	 */
	protected $_cacheTag = 'althea_cms_banner';
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'althea_cms_banner';
	...
	{
		$this->_init('Althea\Cms\Model\ResourceModel\Banner');
	}
