 ...
 */
namespace Althea\Store\Model\Data;
...
class StoreConfig extends \Magento\Framework\Api\AbstractExtensibleObject implements
    \Althea\Store\Api\Data\StoreConfigInterface
{
    const KEY_ID = 'id';
    const KEY_CODE = 'code';
    ...
    const KEY_STATE_REQUIRED = 'state_required';
     ...
     * Set state required
     *
     * @param int $state_required
     * @return $this
     */
    public function setStateRequired($state_required)
    {
        return $this->setData(self::KEY_STATE_REQUIRED, $state_required);
    }
    ...
    {
        return $this->_get(self::KEY_STATE_REQUIRED);
    }
}
