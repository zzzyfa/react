<?php
namespace Althea\EverythingUnder\Block\Product;
...
class ProductsList extends \Magento\Catalog\Block\Product\AbstractProduct implements BlockInterface, IdentityInterface
{
    ...
    /**
     * @var \Althea\EverythingUnder\Model\Rule
     */
    protected $rule;
     ...
     * @param \Althea\EverythingUnder\Model\Rule $rule
    ...
    public function __construct(
        ...
        \Althea\EverythingUnder\Model\Rule $rule,
    ...
    public function getCacheKeyInfo()
    {
        ...
        return [
            'EVERYTHINGUNDER_CATALOG_PRODUCTS_LIST_WIDGET',
    ...
    public function createCollection()
    {
        ...
        $collection = $this->_addProductAttributesAndPrices($collection)
            ->addAttributeToSelect('product_website')
