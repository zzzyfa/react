...
//        );
    ...
    protected function _getRealFieldFromAlias($alias, $topFilter) {
        ...
        switch ($alias) {
            case 'avg_qty_ordered':
                $field = new \Zend_Db_Expr("(warehouse_shipment_item.total_sold / {$numberOfDaySalesPeriod})");
                break;
            case 'total_sold':
            ...
            case 'availability_date':
                ...
                break;
            case 'supply_needs':
                $field = new \Zend_Db_Expr("FLOOR(GREATEST((warehouse_shipment_item.total_sold / {$numberOfDaySalesPeriod} * {$numberForecastDay} - warehouse_product.current_qty),0))");
                break;
        }
        return $field;
    }
    ...
    public function getMoreInformationToExport($topFilter)
    {
        ...
        $infor[] = [__('Warehouse(s)'), $warehouseName];
